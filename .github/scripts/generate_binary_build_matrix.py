...
def generate_wheels_matrix(
    ...
    package_type = "wheel"
    if os == "linux" or os == "linux-aarch64" or os == "linux-s390x" or os == "linux-riscv64":
        # NOTE: We only build manywheel packages for x86_64 and aarch64 and s390x and riscv64 linux
